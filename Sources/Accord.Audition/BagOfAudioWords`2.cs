...
namespace Accord.Audition
{
    ...
    /// 
    [Serializable]
    public class BagOfAudioWords<TFeature, TPoint> : 
        BaseBagOfAudioWords<BagOfAudioWords<TFeature, TPoint>,
            TFeature, TPoint,
            IUnsupervisedLearning<IClassifier<TPoint, int>, TPoint, int>,
