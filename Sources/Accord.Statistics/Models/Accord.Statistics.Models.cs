...
namespace Accord.Statistics.Models
{
    ...
    ///   the <see cref="Accord.Statistics.Models.Markov">hidden Markov models</see>.
    ...
    ///   cref="Accord.Statistics.Distributions">probability distributions</see> to 
    ///   model the observations.</para>
    ///   
    /// <para>
    ///   This namespace also brings <see cref="Accord.Statistics.Models.Fields">
    ...
    ///   models include <see cref="Accord.Statistics.Models.Regression">regression
    ...
    /// </remarks>
    /// 
    /// <seealso cref="Accord.Statistics.Models.Fields"/>
    /// <seealso cref="Accord.Statistics.Models.Markov"/>
    /// <seealso cref="Accord.Statistics.Models.Regression"/>
    /// 
    [CompilerGenerated]
    class NamespaceDoc
    {
